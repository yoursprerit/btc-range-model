...
ax1.axvline(OOS_START, color=C_OOS, lw=1.2, ls="--", alpha=0.7, label="OOS start (Sep 2025)")
...
ax1.set_title("Month-by-Month Portfolio Profile  |  $100k Initial Capital  (⚠️ pre-Sep 2025 = in-sample)",
