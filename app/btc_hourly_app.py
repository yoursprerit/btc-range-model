    ...
    if sigs is not None:
        ...
        if is_live:
            ...
            st.caption(
                ...
                f"MSTR={_mstr_panel_px:.2f if _mstr_panel_px else 'None'} · "
                f"MSTU={_mstu_panel_px:.4f if _mstu_panel_px else 'None'} · "
                f"series_len_mstr={len(_mstr_series) if _mstr_series is not None else 0}"
            )
