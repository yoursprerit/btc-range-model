...
if daily is None or daily.empty:
    ...
    st.stop()
# Completed-bars view for the daily models (same fix as the Gold apps): during
# US market hours Yahoo's daily feed carries an in-progress *today* row whose
# high/low/close are still moving. Forecasting off it would label the "next
# bar" as the day AFTER today while today's own bar is still open (Fri → Mon
