...
XLE crash-shield, and GLDM traded as the gold core sleeve; OOS 2021→now):
**Balanced +713 % / −14.1 % MDD / Sharpe 2.59 · Growth +1,880 % / −22.7 % /
1.71 · Aggressive +2,320 % / −29.8 % / 1.54** vs the equal-weight buy-&-hold
benchmark +229 % / −35.4 % / 0.74. Reproduce with
